...
public partial class Program
{
    ...
    private static void FilesService_SelectPotentialDuplicatesEventHandler(object? sender, EventArgs eventArgs) => Console.WriteLine(((FileEventArgs)eventArgs).Message);
}